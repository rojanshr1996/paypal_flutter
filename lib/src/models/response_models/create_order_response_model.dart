...
abstract class PaymentSourceResponseModel with _$PaymentSourceResponseModel {
  const factory PaymentSourceResponseModel({
  ...
  factory PaymentSourceResponseModel.fromJson(Map<String, dynamic> json) =>
      _$PaymentSourceResponseModelFromJson(json);
}

@freezed
abstract class PaypalPaymentSourceResponseModel
    with _$PaypalPaymentSourceResponseModel {
  ...
  factory PaypalPaymentSourceResponseModel.fromJson(
...
abstract class PurchaseUnitResponseModel with _$PurchaseUnitResponseModel {
  ...
  factory PurchaseUnitResponseModel.fromJson(Map<String, dynamic> json) =>
      _$PurchaseUnitResponseModelFromJson(json);
}

@freezed
abstract class AmountResponseModel with _$AmountResponseModel {
  const factory AmountResponseModel({
    @JsonKey(name: 'currency_code') String? currencyCode,
    String? value,
  }) = _AmountResponseModel;

  factory AmountResponseModel.fromJson(Map<String, dynamic> json) =>
      _$AmountResponseModelFromJson(json);
}
...
abstract class PayeeResponseModel with _$PayeeResponseModel {
  ...
  factory PayeeResponseModel.fromJson(Map<String, dynamic> json) =>
      _$PayeeResponseModelFromJson(json);
}

@freezed
abstract class LinkResponseModel with _$LinkResponseModel {
  const factory LinkResponseModel({String? href, String? rel, String? method}) =
      _LinkResponseModel;

  factory LinkResponseModel.fromJson(Map<String, dynamic> json) =>
      _$LinkResponseModelFromJson(json);
}
